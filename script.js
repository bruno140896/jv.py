(() => {
  ...
  function drawHUD() {
    ...
    if (!portal.active) {
      ...
      obj = "PORTAL ABERTO! Entre no portal para entregar o presente para as criancas!";
    }
  ...
  function drawMenu() {
    ...
    ctx.fillText("Colete bolinhas, derrote os virus e abra o portal das criancas!", W/2, H*0.38 + 42);
  ...
  function drawWin() {
    ...
    ctx.fillStyle = "rgba(255,255,255,0.92)";
    ctx.font = "800 16px system-ui";
    ctx.fillText("Presente entregue para as criancas!", W/2, H*0.40 + 96);
